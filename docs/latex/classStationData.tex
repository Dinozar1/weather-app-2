...
\begin{DoxyCompactList}\small\item\em Fetches station data from the specified URI. \end{DoxyCompactList}\item 
...
Fetches station data from the specified URI. 


\begin{DoxyParams}{Parameters}
{\em uri} & The URI endpoint to fetch data from \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\hline
{\em user} & Pointer to user data (string buffer) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
